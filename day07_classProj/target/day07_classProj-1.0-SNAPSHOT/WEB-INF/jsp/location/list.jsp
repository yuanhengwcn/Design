        ...
        $(function () {
            ...
            $("a.btn-delete").click(function () {
                if (confirm("你确定删除吗？")) {
                    ...
                    location.href = "/location/delete?id=" + $(this).attr("demo");
                }
            })
            ...
            $("a.btn-edit").click(function () {
                if (confirm("你确定编辑吗？")) {
                    // 点击之后携带信息跳转到/edit接口
                    location.href = "/location/edit?id=" + $(this).attr("demo");
                }
            })
        })
    </script>
        ...
        <div class="input-group">
            ...
            <select class="form-control" name="countryName">
                ...
                <c:forEach items="${pageInfo.list}" var="c">
                    ...
                    <option value="${c.countryName}" ${locationVO.countryName == c.countryName ? "selected='selected'" : ""}>
                            ${c.countryName}
                    </option>
